...
public class CharacterEntityBlockEvent extends CharacterEntityEvent {

	private final CharacterEntity otherEntity;

	private final Hit hit;

	public CharacterEntityBlockEvent(CharacterEntity entity, CharacterEntity otherEntity, Hit hit) {
		super(entity);
